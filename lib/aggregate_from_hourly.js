...
// "header":["ts","n","hh","not_hh","o","avg_veh_spd","avg_hh_weight","avg_hh_axles","avg_hh_spd","avg_nh_weight","avg_nh_axles","avg_nh_spd","miles","lane_miles","detector_count"]
    ...
    return function(err,text){
        ...
        // iterate over each group
            ...
            //                   throw new Error();
                ...
                aggoutput.features[0].properties.data.push( end );
            });
